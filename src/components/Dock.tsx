...
const DOCK_APPS: AppId[] = ["code-editor", "terminal", "notes", "ssh"];
...
export default function Dock() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-9999 flex items-center p-4">
      <div className="flex gap-2 p-0 bg-neutral-900/90 backdrop-blur-md border border-neutral-700 rounded-xl shadow-2xl items-center">
        {DOCK_APPS.map((appId) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center gap-1 px-4 py-2.5 rounded-lg transition-colors cursor-pointer group ${
        ...
        {hasWindows && (
          <>
            ...
            <button
              ...
              className="flex flex-col items-center gap-1 px-4 rounded-lg hover:bg-neutral-800 transition-colors cursor-pointer group"
      ...
      {minimized.length > 0 && (
        <div className="flex gap-1 ml-2 px-3 py-2.5 bg-neutral-900/90 backdrop-blur-md border border-neutral-700 rounded-xl shadow-2xl items-center">
          {minimized.map((win) => {
